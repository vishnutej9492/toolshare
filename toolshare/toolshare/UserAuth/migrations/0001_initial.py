...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('UserAuth_userprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('add_line1', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('add_line2', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('zipcode', self.gf('django.db.models.fields.IntegerField')()),
            ('state', self.gf('localflavor.us.models.USStateField')(max_length=2)),
            ('reminder_preferences', self.gf('django.db.models.fields.IntegerField')()),
            ('pickup_loc', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('UserAuth', ['UserProfile'])


    def backwards(self, orm):
        # Deleting model 'UserProfile'
        db.delete_table('UserAuth_userprofile')
