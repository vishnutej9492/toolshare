...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tool.identifier'
        db.add_column('ToolMgmt_tool', 'identifier',
                      self.gf('django.db.models.fields.CharField')(null=True, blank=True, max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tool.identifier'
        db.delete_column('ToolMgmt_tool', 'identifier')
    ...
    models = {
        'ToolMgmt.tool': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['UserAuth.UserProfile']", 'null': 'True'}),
